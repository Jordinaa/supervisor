...
def position_cb(msg):
    ...
    # log roll and pitch to CSV
    data = [roll, pitch]
    filename = '/home/taranto/catkin_ws/src/offboard_py/data'
    log_data_to_csv(filename, data)
...
def logger_node():
    ...
    while not rospy.is_shutdown():
        ...
        data = [roll, pitch]
        log_data_to_csv(filename, data)  # log data to csv
        rospy.loginfo(f"Roll: {roll}, Pitch: {pitch}")
        rospy.sleep(1.0)
